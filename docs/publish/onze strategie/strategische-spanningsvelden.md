...
**Input**:
- [Hypothese Probleemkader](hypothese-probleemkader-mandarin.md)
...
```mermaid
graph TB
    subgraph "Fundamentele Hypothese"
        H[Agent-ecosysteem:<br/>Expliciet, Governable, Traceerbaar]
        A1[Aanname 1:<br/>Expliciete Kennisdeling]
        A2[Aanname 2:<br/>Voorspelbaarheid]
        A3[Aanname 3:<br/>Opbrengst vs Inspanning]
    end

    subgraph "Strategische Intenties 2026-2031"
        I1[Intentie 1:<br/>Product met bewezen waarde<br/>€1M+ investeerders]
        I2[Intentie 2:<br/>Fundament & Praktijk<br/>TLX 2026-2028]
        I3[Intentie 3:<br/>Licentieerbaar Product<br/>2028-2031]
    end

    subgraph "Spanningsveld 1: Kennisdeling"
        S1A[Expliciete kennis<br/>documenteren]
        S1B[Weerstand &<br/>Tijdsdruk]
        S1A <-->|spanning| S1B
    end

    subgraph "Spanningsveld 2: Governance"
        S2A[Structuur &<br/>Voorspelbaarheid]
        S2B[Complexiteit &<br/>Overhead]
        S2A <-->|spanning| S2B
    end

    subgraph "Spanningsveld 3: Timing"
        S3A[Practice-First<br/>Bewijs in TLX]
        S3B[Commerciële Druk<br/>Investeerders]
        S3A <-->|spanning| S3B
    end

    subgraph "Spanningsveld 4: Schaalbaarheid"
        S4A[Zelfstandige<br/>Klanten]
        S4B[Product-<br/>complexiteit]
        S4A <-->|spanning| S4B
    end

    subgraph "Spanningsveld 5: Ontwikkeling"
        S5A[Stabiliteit &<br/>Volwassenheid]
        S5B[Snelheid &<br/>Innovatie]
        S5A <-->|spanning| S5B
    end

    subgraph "Spanningsveld 6: Richting"
        S6A[Architectuur<br/>Leidend]
        S6B[Marktbehoeften &<br/>Klanten]
        S6A <-->|spanning| S6B
    end

    subgraph "Spanningsveld 7: Commercie"
        S7A[Commerciële<br/>Ambitie]
        S7B[Sales Capabilities<br/>& GTM Ervaring]
        S7A <-->|spanning| S7B
    end
    ...
    style H fill:#e55039,color:#fff
    style I1 fill:#ff6348,color:#fff
    style I2 fill:#ff6348,color:#fff
    style I3 fill:#ff6348,color:#fff
    
    style S1A fill:#feca57
    style S1B fill:#54a0ff
    style S2A fill:#feca57
    style S2B fill:#54a0ff
    style S3A fill:#feca57
    style S3B fill:#54a0ff
    style S4A fill:#feca57
    style S4B fill:#54a0ff
    style S5A fill:#feca57
    style S5B fill:#54a0ff
    style S6A fill:#feca57
    style S6B fill:#54a0ff
    style S7A fill:#feca57
    style S7B fill:#54a0ff
```
