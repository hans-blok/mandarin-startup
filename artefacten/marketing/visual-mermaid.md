...
2. Klik op "Open Preview" (of Ctrl+Shift+V)
3. De Mermaid diagrammen worden automatisch gerenderd

### In GitHub:
1. Push dit bestand naar GitHub
2. Bekijk het in de browser - GitHub rendert Mermaid automatisch

### In MkDocs:
Voeg toe aan je mkdocs.yml:
```yaml
markdown_extensions:
...
### Export als PNG/SVG:
1. Gebruik https://mermaid.live
2. Plak de Mermaid code
3. Download als PNG/SVG

---

## Welke versie past het beste?

- **Graph TD**: Meest gedetailleerd, alle tekst zichtbaar
- **Flowchart**: Cleaner, overzichtelijker voor presentatie
- **Mindmap**: Meest compact, goed voor quick overview
